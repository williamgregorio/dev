...
const emails = [
  {type: emailTypes.promotional[0], description: "A responsive email for a new product announcement.", imageFileName:"katz-newsletter-portfolio.png", filename: "katz-promotional-product-announcement.html"},
  {type: emailTypes.transactional[4], description: "A responsive new payment receipt email for a service business.", imageFileName:"stripe-first-transaction.png", filename: "stripe-transactional-payment-receipt.html"},
]
...
function showPopup() {
  ...
  const popupXDiv = document.createElement("div");
  popupXDiv.className += "close-popup";
  const popupXIMG= document.createElement("img");
  popupXIMG.className += "x-close";
  popupXIMG.setAttribute("src", `assets/close-bold.svg`);
  popupXDiv.append(popupXIMG);
  popup.append(popupXDiv);
