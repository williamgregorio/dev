 ...
 * @param {string} emailType - The type/subcategory of the email.
 * @param {string} description - A brief description of the email.
 * @param {string} viewOnlineFileName - The file name for the "view online" link.
 * @param {string} imageFileName - The file name of the email's thumbnail image.
