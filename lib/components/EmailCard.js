  ...
  const clientsSection = createElement("div", {
    ...
    children: [
      ...
      createElement("div", {
        ...
        children: emailClients.map(({ name, image }) =>
          createElement("div", {
            ...
            children: [
              createElement("div", {
                ...
                children: [
                  createElement("img", {
                    src: `${root}/email-client-logos/${image}`,
                    alt: `${name} Logo`,
                  }),
                ],
              }),
  ...
  return createElement("div", {
    ...
    children: [
      ...
      createElement("div", {
        ...
        children: [
          createElement("h5", { textContent: `Subject:` }),
          createElement("p", { textContent: subject }),
        ],
      }),
      createElement("div", {
        ...
        children: [
          ...
          createElement("div", {
            className: "email-subcategory-type",
            textContent: emailType,
          }),
        ],
      }),
      createElement("a", {
